...
public class SpannerMarkdown {
    ...
    private static final String REGEX_CODE_BLOCK = "((```)([\\s\\S]*?)(```))|((`)([\\s\\S]*?)(`))";
    ...
    private static final Spanner.MatchStrategy STRATEGY_BOLD_ITALIC = new Spanner.MatchStrategy(PATTERN_BOLD_ITALIC, new Spanner.OnMatchListener() {
        @Override
        public Spanner.Replacement call(Matcher matcher) {
            return new Spanner.Replacement(matcher.group(), new BoldItalicSpan());
        }
    });
    ...
    private static final Spanner.MatchStrategy STRATEGY_BOLD = new Spanner.MatchStrategy(PATTERN_BOLD, new Spanner.OnMatchListener() {
        @Override
        public Spanner.Replacement call(Matcher matcher) {
            return new Spanner.Replacement(matcher.group(), new BoldSpan());
        }
    });
    ...
    public static Spanner.MatchStrategy forCodeBlock(final OnCodeBlockMatchListener onMatchListener) {
        return new Spanner.MatchStrategy(PATTERN_CODE_BLOCK, new Spanner.OnMatchListener() {
            @Override
            public Spanner.Replacement call(Matcher matcher) {
